...
### **二、案例体系设计**
#### 1. **基础教学案例库**
- 案例1：[arxiv_research](https://github.com/moxin-org/mofa/tree/main/python/examples/arxiv_research)
- 案例2：[deep-inquire](https://github.com/moxin-org/mofa/tree/main/python/examples/deep-inquire)
- 案例3：[deepseek_serper](https://github.com/moxin-org/mofa/tree/main/python/examples/deepseek_serper)
